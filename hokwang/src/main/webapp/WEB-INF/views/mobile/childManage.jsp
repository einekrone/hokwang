		...
		$('body').on('click','#mobile-babyinfo tr',function(){
			...
			$.ajax({
				...
				success: function(data){
					...
					modal.find('#baby-regno1').attr("readonly",true).val(data.baby_regno1);
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form name="frm" id="frm" encType="multipart/form-data" method="post" action="insertbabyinfo">
						<div class="form-group">
							...
							<div class="form-group">
								<input type="password" class="form-control" id="baby-regno2" name="baby_regno2" placeholder="뒷자리 7자리"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
								<label>이름</label><input type="text" class="form-control" id="baby-name" name="baby_name"  placeholder="이름" >
							</div>
							<input type="hidden" class="form-control" id="parent-no" name="parent_no">
							<div class="form-group">
								<label>생년월일</label><input type="number" class="form-control" id="baby-regno1" name="baby_regno1" placeholder="생년월일 6자리 ex)910504" 
								maxlength="6" oninput="numberMaxLength(this);">
							</div>
							<div class="form-group">
							<label>성별</label>
