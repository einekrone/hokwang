		...
		$.ajax({
			...
			success : function(data) {
				...
				$.each(data, function(idx,item) {
					$('div#imgInf').append($('<img>').attr("src","${pageContext.request.contextPath}/resources/img/"+item.baby_pic).attr("width","100px").attr("width","100px"));
				});
			}
		})
	}
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<input type="text" class="form-control" id="baby-regno1" name="baby_regno1" placeholder="생년월일"><br>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-form-label">사진등록</label><br>
								 <div style="width:500px; height:300px; background-color:white;" class="img-print">
